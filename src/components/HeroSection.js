...
import mainbgpic from "../assets/images/bg/mainbg5.jpg";
import mkpic1 from "../assets/images/bg/MK010.png";
        ...
        <div className="relative border-white rounded-2xl bg-black/60 border-[1px]">
          <div className="container relative grid grid-cols-1 gap-8 px-4 mx-auto mt-0 md:grid-cols-2">
            <div className="relative mt-12 main_pic_container">
              <img src={mkpic1} alt="FOM" className="main_pic 3d_pic" />
            </div>
            <div className="flex flex-col items-start justify-center mb-6 text-center md:text-left">
              <h1 className="mb-6 font-bold text-white uppercase main_hero_text text-[5.5rem] md:text-[4rem] lg:text-[5.5rem] xl:text-[6.5rem]">
                The <br />
                <span className="text-[#ff7b00]">Official</span> <br /> $FOM
                MEME
              </h1>
              ...
              <p className="mb-8 text-[32px] font-[200]">
                Join the $FOM Community, lets make History Now.
              </p>
              <button className="px-6 py-2 text-white bg-[#ff7b00] rounded-lg shadow-lg hover:bg-orange-500 m-auto md:m-0 text-[24px] font-bold uppercase">
                Buy $FOM
              </button>
            </div>
          </div>
          <div className="bottom-0 flex flex-col items-center justify-center mt-8">
            ...
            <div className="p-10">
              <h6>
                The $FOM Memes celebrate FOM's journey from a street kid to a
                global icon, embodying the power of opportunity and resilience.
                These tokens are meant to foster community engagement and
                symbolize solidarity with the values of hope and empowerment
                that FOM’s life represents. These memes are strictly meant for
                community support and engagement; they are not investments, do
                not represent investment contracts, and are not to be considered
                securities in any form. See Terms & Conditions{" "}
                <span
