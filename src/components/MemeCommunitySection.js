  ...
  >
    <div className="container grid gap-8 px-4 py-10 mx-auto md:grid-cols-2 rounded-xl">
      <div className="flex flex-col gap-5">
        <div class="about_left_text text-[#ff7b00]">
          Join the $FOM Meme community!
        </div>
        <p className="p-6 text-lg leading-relaxed text-white bg-black rounded-xl">
          ...
          opportunities for growth and creative expression, we aim to inspire
          and uplift every child to see beyond their circumstances and realize
